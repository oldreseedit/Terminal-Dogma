	...
	<div class="modal-wrapper">
		<div class="container">
			<form id="modifyPreferenceForm" name="modifyPreferenceForm" ng-submit="preference.close(preference.form[preference.data.id])" novalidate>
				...
				<bootstrap-input form="modifyPreferenceForm" name="{{preference.data.id}}" type="text" ng-model="preference.form[preference.data.id]" placeholder="{{preference.placeholder()}}" required="required"></bootstrap-input>
