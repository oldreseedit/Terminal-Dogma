<div id="navbar-responsive" ng-if="imOnResponsive" navbar-left>
	...
	<div id="menu" ng-controller="navbarController as navbar">
		<h3>Sezioni</h3>
		<a ng-click="navbar.goTo('/')"><span class="fa-stack middle"><i class="fa fa-home fa-stack-2x"></i></span> <h5 class="inline"><span title="Torna alla home" class="middle">Home</span></h5> </a>
			...
			<div class="container">
				<div class="navbar-profile-name">
	                ...
	                <a title="Clicca per impostare un nuovo avatar" ng-mouseenter="hover = true" ng-mouseleave="hover = false" ng-click="avatar.changeAvatar(username,avatarURI)" ng-controller="avatarController as avatar">
	                	<span class="fa-stack fa-3x clickable" ng-if="thereIsAvatar()">
	                		<span class="fa-stack" >
		            ...
		            <a title="Accedi al tuo profilo" ng-click="navbar.goTo('/profile/{{username}}')">
	                	<h4 class="inline no-padding middle white" ng-bind="username"></h4>
	                </a>
	                <div class="navbar-icons">
		                <div>
							<a title="Vedi le nuove notifiche" ng-click="navbar.goTo('/profile/{{username}}')">
	                 		...
	                 		<a title="Imposta le preferenze del tuo profilo" ng-click="navbar.goTo('/preferences')">
		                    	<span class="fa-stack clickable">
	                    ...
	                    <div>
		                    <a title="Vai al carrello" ng-click="navbar.goTo('/cart')" ng-class="{'cart-not-empty': cart.getCart().items.length > 0}">
		                    	<span class="fa-stack clickable">
		                    ...
		                    <a title="Accedi al registro" ng-click="navbar.goTo('/register')" ng-if="admin">
		                    	<span class="fa-stack clickable">
