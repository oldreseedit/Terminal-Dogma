	...
	<div class="modal-wrapper">
		<div class="container">
			<form id="modifyPreferenceForm" name="modifyPreferenceForm" ng-submit="preference.close(preference.form.value)" novalidate>
				...
				<bootstrap-input form="modifyPreferenceForm" name="{{preference.data.id}}" type="email" ng-model="preference.form.value" placeholder="{{preference.placeholder()}}" required="required"></bootstrap-input>
