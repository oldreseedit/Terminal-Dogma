    ...
    <div class="modal-wrapper">
        <div class="container">
            ...
            <form id="signinForm" name="signinForm" ng-submit="signin.submit()" novalidate>
                ...
                <input class="modal-submit" type="submit" ng-class="{'btn-success' : signinForm.$valid, 'btn-grey' : signinForm.$invalid}" value="Accedi" />
                <input class="modal-submit" ng-click="$dismiss()" value="Annulla" readonly/>
            </form>
        </div>
    </div>
</div>