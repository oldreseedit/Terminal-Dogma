<div id="team" ng-controller="teamController as team">
    <div class="container">
        ...
        <div id="team-wrapper">
            <div class="container">
                <div ng-repeat="own in team.people" id="{{own.id}}" ng-class="team.spacedPeople($first)" class="person">
                    <div class="container">
                        ...
                        <div class="team-social-buttons">
                            <div class="container">
                                <a ng-repeat="icon in own.socialNetworks" ng-href="{{icon.url}}" target="_blank">
                                    <div class="fa-stack fa-lg" ng-class="team.spacedIcons($first)" ng-init="hover=imOnResponsive">
