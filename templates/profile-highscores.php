<table class="table table-striped text-center profile-high-scores">
	<tr>
		...
		<td class="bg-grey"  ng-if="!imOnResponsive"><p>Esperienza</p></td>
	</tr>
	<tr ng-repeat="score in profile.highscores">
		...
		<td  ng-if="!imOnResponsive"><p><span title="{{score.exp}}" ng-bind="(score.exp | experiencePointsFormatter)"></span></p></td>
	</tr>
</table>