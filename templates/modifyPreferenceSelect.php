	...
	<div class="modal-wrapper">
		<div class="container">
			<form id="modifyPreferenceForm" name="modifyPreferenceForm" ng-submit="preference.close(preference.form[preference.data.id])" novalidate>
				...
				<select class="form-control" ng-model="preference.form[preference.data.id]" ng-options="choice as choice for choice in preference.data.choices" required="required">
					<option></option>
				</select>
