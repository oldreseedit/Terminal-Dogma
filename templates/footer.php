            ...
            <div class="container">
                <a ng-repeat="icon in footer.icons" ng-href="{{icon.url}}" target="_blank">
                    <div class="fa-stack fa-2x" ng-class="footer.spacedIcons($first)">
                        <i class="fa fa-stack-2x fa-circle" ng-class="footer.getColors(icon,hover)"></i>
                        <i class="fa fa-stack-1x" ng-class="footer.getColorsInverse(icon,hover)" ng-mouseover="hover=true;" ng-mouseleave="hover=false;"></i>
                    </div>
                </a>
            </div>
        </div>
