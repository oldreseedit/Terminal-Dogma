<div id="footer" ng-controller="footerController as footer">
    <div class="container">
        <div id="social-icons" ng-if="!imOnResponsive">
            <div class="container">
                <a ng-repeat="icon in footer.icons" ng-href="{{icon.url}}" target="_blank">
                    <div class="fa-stack" ng-class="footer.spacedIcons($first)">
        ...
        <div id="tabs">
            <div class="container">
                <div ng-repeat="tab in footer.tabs" class="tab" ng-class="footer.spaced($first)"><p><a ng-href="/{{tab.id}}" id="{{tab.id}}" ng-bind="tab.content" class="animated-class-fastest"></a></p></div>
            </div>
        </div>
        <div id="social-icons" ng-if="imOnResponsive">
            <div class="container">
