<div id="singleCourse">
    <div class="container">
        <div gridster>
            <div class="gridster-item bg-light-grey" gridster-item="course.customItemMap" id="gridsterItem{{index}}" ng-repeat="item in course.items" ng-init="index = $index" size-on-controller>
                <div class="container" ng-if="course.gridsterIsReady">
                    ...
                    <div class="course-panel-content">
                        <div class="container" id="gridsterItem{{index}}View" size-on-controller>
