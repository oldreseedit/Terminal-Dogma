...
class PayPal_Adaptive extends PayPal_Pro
{
	...
	{
		print("CALLING: " . $this -> EndPointURL . $APIName . '/' . $APIOperation);
		...
		$curl = curl_init();
				...
				curl_setopt($curl, CURLOPT_HTTPHEADER, $this -> BuildHeaders(true));
